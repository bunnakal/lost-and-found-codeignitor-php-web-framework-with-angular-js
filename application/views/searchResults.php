...
<body ng-controller="homeCtrl">
	...
	<div class="row">
				...
				<form action="<?php echo base_url();?>lost_found/searchResults"
					...
					<div class="form-group">
						<label class="control-label" for="inputGroup">Search</label> <select
							...
							<option value="<?php echo $firstOptionValue;?>"><?php echo $firstOption;?></option>
							<option value="<?php echo $secondOptionValue;?>"><?php echo $secondOption;?></option>
						</select>
					</div>
		...
		<div class="col-md-9 custom-col-2" id="partials">
			<!-- advenced search -->
			<?php
			$this->load->view('../../assets/partials/searchResults.php');
			?>
			<!-- end advanced search -->
		</div>
	</div>
