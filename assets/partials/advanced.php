<div id="right-side-advanced">
	<div class="col-md-12">
		<h2 class="page-header">Advanced Search</h2>
	</div>
	<br />
	<div class="col-md-7 col-md-offset-1">
		<form action="<?php echo base_url();?>lost_found/advancedSearchRes"
			method="post" role="form" enctype="multipart/form-data">
			<div class="row" ng-show="searchStep == 0">
				<div class="col-md-2">
			...
			<div class="panel panel-info" ng-show="searchStep == 0">
			...
			<div class="panel panel-info" ng-show="searchStep == 1">
				<div class="panel-heading">
			...
			<div class="probBtn pull-right" id="continueBtn-search"
				style="margin-right: 10px;" ng-show="searchStep == 0">
				<a href=""><button type="button" class="btn btn-default"
						ng-click="searchStep = searchStep + 1">
						Continue <span class="glyphicon glyphicon-forward"></span>
					</button> </a>
			</div>

			<div class="probBtn pull-left" id="continueBtn-search"
				style="margin-right: 10px;" ng-show="searchStep == 1">
				<a href=""><button type="button" class="btn btn-default"
						ng-click="searchStep = searchStep - 1">
